...
class GraphWin(tk.Canvas):
    ...
    def getMousePos(self):
        return Point(self.winfo_pointerx() - self.winfo_rootx(), self.winfo_pointery() - self.winfo_rooty())
...
class _BBox(GraphicsObject):
    ...
    def __init__(self, topLeft, bottomRight, options=["outline", "width", "fill"]):
    ...
    def moveTopLeft(self, x, y):
        self.move(x - self.topLeft.x, y - self.topLeft.y)

    def getTopLeft(self): return self.topLeft.clone()

    def getBottomRight(self): return self.bottomRight.clone()
...
class Rectangle(_BBox):
    ...
    def __init__(self, topLeft, bottomRight):
        _BBox.__init__(self, topLeft, bottomRight)

    def __repr__(self):
        return "Rectangle({}, {})".format(str(self.topLeft), str(self.bottomRight))

    def _draw(self, canvas, options):
        topLeft = self.topLeft
        bottomRight = self.bottomRight
        x1, y1 = canvas.toScreen(topLeft.x, topLeft.y)
        x2, y2 = canvas.toScreen(bottomRight.x, bottomRight.y)
        return canvas.create_rectangle(x1, y1, x2, y2, options)

    def clone(self):
        other = Rectangle(self.topLeft, self.bottomRight)
        other.config = self.config.copy()
        return other
...
class Oval(_BBox):
    ...
    def __repr__(self):
        return "Oval({}, {})".format(str(self.topLeft), str(self.bottomRight))

    def clone(self):
        other = Oval(self.topLeft, self.bottomRight)
        other.config = self.config.copy()
        return other
...
class Circle(Oval):
    ...
    def __init__(self, center, radius):
        ...
        Oval.__init__(self, topLeft, bottomRight)
        self.radius = radius
...
class Line(_BBox):
    ...
    def __repr__(self):
        return "Line({}, {})".format(str(self.topLeft), str(self.bottomRight))

    def clone(self):
        other = Line(self.topLeft, self.bottomRight)
        other.config = self.config.copy()
        return other
